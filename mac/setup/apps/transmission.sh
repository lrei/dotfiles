...
defaults write org.m0k.transmission DownloadFolder -string "${HOME}/Stuff"

# Set incomplete downloads location
defaults write org.m0k.transmission UseIncompleteDownloadFolder -bool true
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${HOME}/Downloads/TempTorrents"

# Hide incomplete downloads folder
mkdir -p "${HOME}/Downloads/TempTorrents"
sudo chflags -h hidden "${HOME}/Downloads/TempTorrents"
